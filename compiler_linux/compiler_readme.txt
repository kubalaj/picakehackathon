PICAXE Compilers
(c) Revolution Education Ltd 2011
...
Each compiler consists of a console application with a filename that 
is the same as the type of chip supported e.g. picaxe08m
...
For the 40X2 part use the picaxe28x2 compiler.
